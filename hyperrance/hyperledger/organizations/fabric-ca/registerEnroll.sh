...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://insurancecore:insurancecorepw@localhost:7054 --caname ca-insurance --tls.certfiles ${PWD}/organizations/fabric-ca/insurance/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://hospitalcore:hospitalcorepw@localhost:8054 --caname ca-hospital --tls.certfiles ${PWD}/organizations/fabric-ca/hospital/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://customercore:customercorepw@localhost:10054 --caname ca-customer --tls.certfiles ${PWD}/organizations/fabric-ca/customer/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://orderercore:orderercorepw@localhost:9054 --caname ca-orderer --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x
